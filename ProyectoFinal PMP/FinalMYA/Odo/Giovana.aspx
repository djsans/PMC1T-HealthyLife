<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giovana.aspx.cs" Inherits="acordeon.Perfil_medico" %>
...
<body>
    ...
    <footer>
        ...
        <br />
        <br />
        <asp:Button ID="Button1" CssClass="buttonatras" runat="server" Text="< Atrás" OnClick="Button1_Click1" />
        <div style="text-align: center;" class="container">
            <!-- Trigger the modal with a button -->
            <button type="button" id="btnH" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Ver Horario</button>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 style="text-align: center;" class="modal-title">Horario</h4>
                        </div>
