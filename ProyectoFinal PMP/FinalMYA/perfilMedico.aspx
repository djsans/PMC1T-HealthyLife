<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="perfilMedico.aspx.cs" Inherits="FinalMYA.WebForm1" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div id="fotoMedico" class="auto-style1">
            <img src="FotosDoctores/fotoP.png" />
        </div>
        <div id="infoMedico">
            <h2 style="text-align: center; color: #2471A3;">Armando Casas</h2>
            <div id="infoMedico2">
                <h4>Especialidad:</h4>
                <p>XXXXXXXXXX</p>
                <h4>Sexo:</h4>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 style="text-align: center;" class="modal-title">Mi Horario</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <asp:Button ID="Button2" CssClass="btn" runat="server" Text="Editar" OnClick="Button2_Click" />
                            </div>
                        </div>
